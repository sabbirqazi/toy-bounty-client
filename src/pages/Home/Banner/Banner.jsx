      ...
      <div className="carousel w-full h-[90vh]">
        <div id="slide1" className="carousel-item relative w-full">
          <img
            ...
            className="w-full"
          />
          <div className="absolute w-full flex items-center h-full bg-gradient-to-t from-rose-50 to-[rgba(21, 21, 21, 0)]">
            <div className="text-white space-y-7 flex flex-col items-center justify-center lg:ml-48">
              <h2 className="text-6xl font-bold text-center">
                A New Box Of Toy Everymonth!!!
              </h2>
              <p>
              ...
              <div>
                <button className="btn btn-primary">Get Yours</button>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img
            ...
            className="w-full"
          />
          <div className="absolute w-full flex items-center h-full bg-gradient-to-b from-[#E0EAFC] to-[rgba(21, 21, 21, 0)]">
